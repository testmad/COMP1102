...
David Walker
Comp-1102 Project 4 extra - data file generator
Assigned: 	11-10-2014
Due:		11-14-2014
...
int main(void)
{
    ...
    {
        string firstName[10] = { "James", "John", "George", "Dave", "Steve", "Mary", "Jane", "Susie", "Kate", "Jean" };
        string lastName[10] = { "Doe", "Jones", "Smith", "Chan", "Brown", "Johnson", "Garcia", "Miller", "Wilson", "Rodriguez" };
